...
static class HarmonyPatches
{
	static HarmonyPatches()
	{
		...
		Verse.Log.Message("SmartHaul v1.0¼ welcomes you to RimWorld with pointless logspam.");
	}
	...
	public static bool SkipCorpses_Prefix(WorkGiver_Haul __instance, ref bool __result, Pawn pawn)
	{
		...
		if (Settings.AllowCorpses //Don't use the vanilla HaulCorpses WorkGiver if SH is allowed to haul those
	...
	public static IEnumerable<CodeInstruction> GearTabHighlightTranspiler(IEnumerable<CodeInstruction> instructions, MethodBase method)
	{
		...
		if (!done)
		{
			Verse.Log.Warning("Smart Haul failed to patch ITab_Pawn_Gear.DrawThingRow. This is only used for coloring and totally harmless, but you might wanna know anyway");
		}
	}
